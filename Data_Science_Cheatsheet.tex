...
\begin{center}
\vspace{-50mm}
     \Large{\vspace{-15mm}\textbf{Data Science Cheat Sheet}} \\
...
% ----------------------------------------------------------------
\section{\href{https://migue-rc.github.io/Data-Science-Cheatsheet/\#statistics}{Statistics}}
...
% % ---------------------------------------------------------
\subsection{\href{https://migue-rc.github.io/Data-Science-Cheatsheet/\#continuous-distributions}{Continuous Distributions}}
...
\section{\href{https://migue-rc.github.io/Data-Science-Cheatsheet/\#Concepts}{Concepts}}
% ---------------------------------------------------------------
...
% \section{\href{https://migue-rc.github.io/Data-Science-Cheatsheet/\#k-nearest-neighbors}{Statistics}}
...
\vspace{-.5mm}
$\boldsymbol{z}$\textbf{-score} - the number of standard deviations between a data point $x$ and the mean $\to \frac{x - \mu}{\sigma}$
\vspace{-.5mm}
$\boldsymbol{t}$\textbf{-test} - used when population variances are unknown, and converges to the $z$-test when $n$ is large
\vspace{-.5mm}
$\boldsymbol{t}$\textbf{-score} - uses the standard error as an estimate for population variance $\to \frac{x - \mu}{s/\sqrt{n}}$
\vspace{-.5mm}
...
\columnbreak
% -------------------------------------------------
\section{\href{https://migue-rc.github.io/Data-Science-Cheatsheet/\#model-evaluation}{Model Evaluation}}
% -----------------------------------------------
...
% ----------------------------------------------------------------
\section{\href{https://migue-rc.github.io/Data-Science-Cheatsheet/\#linear-regression}{Linear Regression}}
...
\columnbreak
% ----------------------------------------------------------------
\section{\href{https://migue-rc.github.io/Data-Science-Cheatsheet/\#logistic-regression}{Logistic Regression}}
% ----------------------------------------------------------------
...
% -------------------------------
\vspace{-.5mm}
\section{\href{https://migue-rc.github.io/Data-Science-Cheatsheet/\#decision-trees}{Decision Trees}}
\subsection{\href{https://migue-rc.github.io/Data-Science-Cheatsheet/\#classification-and-regression-tree}{Classification and Regression Tree}}
...
\vspace{-1mm}
\itemsep -.4mm
\item Gini Impurity $= 1 - \sum_i (\hat{p_i})^2$
...
\subsection{\href{https://migue-rc.github.io/Data-Science-Cheatsheet/\#random-forest}{Random Forest}}
...
% ----------------------------------------------------------------
\section{\href{https://migue-rc.github.io/Data-Science-Cheatsheet/\#support-vector-machines}{Support Vector Machines}}
...
\end{center}
\vspace{-3.5mm}
\subsection{\href{https://migue-rc.github.io/Data-Science-Cheatsheet/\#multiclass-prediction}{Multiclass Prediction}}
...
% ---------------------------------------------------
\section{\href{https://migue-rc.github.io/Data-Science-Cheatsheet/\#k-nearest-neighbors}{k-Nearest Neighbors}}
...
% ----------------------------------------------------------------
\textcolor{white}{.}\vspace{-5mm}\\ % Add space above column
\section{\href{https://migue-rc.github.io/Data-Science-Cheatsheet/\#clustering}{Clustering}}
Unsupervised, non-parametric methods that groups similar data points together based on distance
\subsection{\href{https://migue-rc.github.io/Data-Science-Cheatsheet/\#k-means}{k-Means}}
...
% ----------------------------------------------------------------
\subsection{\href{https://migue-rc.github.io/Data-Science-Cheatsheet/\#hierarchical-clustering}{Hierarchical Clustering}}
...
% ----------------------------------------------------------------% ----------------------------------------------------------------
\textcolor{white}{.}\vspace{-5mm}\\ % Add space above column
\section{\href{https://migue-rc.github.io/Data-Science-Cheatsheet/\#dimension-reduction}{Dimension Reduction}}
...
\subsection{\href{https://migue-rc.github.io/Data-Science-Cheatsheet/\#principal-component-analysis}{Principal Component Analysis}}
...
% ----------------------------------------------------------------
\subsection{\href{https://migue-rc.github.io/Data-Science-Cheatsheet/\#linear-discriminant-analysis}{Linear Discriminant Analysis}}
...
% ----------------------------------------------------------------
\subsection{\href{https://migue-rc.github.io/Data-Science-Cheatsheet/\#factor-analysis}{Factor Analysis}}
...
% ----------------------------------------------------------------
\\\textcolor{white}{.}\vspace{-5mm}\\ % Add space above column
\section{\href{https://migue-rc.github.io/Data-Science-Cheatsheet/\#natural-language-processing}{Natural Language Processing}}
...
\subsection{\href{https://migue-rc.github.io/Data-Science-Cheatsheet/\#word-embedding}{Word Embedding}}
...
\subsection{\href{https://migue-rc.github.io/Data-Science-Cheatsheet/\#sentiment-analysis}{Sentiment Analysis}}
...
\subsection{\href{https://migue-rc.github.io/Data-Science-Cheatsheet/\#topic-modelling}{Topic Modelling}}
...
% -------------------------------------------------------------
\textcolor{white}{.}\vspace{-5mm}\\ % Add space above column
\section{\href{https://migue-rc.github.io/Data-Science-Cheatsheet/\#neural-network}{Neural Network}}
...
% -------------------------------------------------------------% -------------------------------------------------------------
\textcolor{white}{.}\vspace{-5mm}\\ % Add space above column
\section{\href{https://migue-rc.github.io/Data-Science-Cheatsheet/\#convolutional-neural-network}{Convolutional Neural Network}}
...
\section{\href{https://migue-rc.github.io/Data-Science-Cheatsheet/\#recurrent-neural-network}{Recurrent Neural Network}}
...
\section{\href{https://migue-rc.github.io/Data-Science-Cheatsheet/\#boosting}{Boosting}}
...
% -------------------------------------------------------------% -------------------------------------------------------------
\section{\href{https://migue-rc.github.io/Data-Science-Cheatsheet/\#recommender-systems}{Recommender Systems}}
...
% -------------------------------------------------------------% -------------------------------------------------------------
\\\textcolor{white}{.}\vspace{-3mm}\\ % Add space above column
\section{\href{https://migue-rc.github.io/Data-Science-Cheatsheet/\#reinforcement-learning}{Reinforcement Learning}}
...
% ----------------------------------------------------------------
\textcolor{white}{.}\vspace{-3mm}\\ % Add space above column
\section{\href{https://migue-rc.github.io/Data-Science-Cheatsheet/\#anomaly-detection}{Anomaly Detection}}
...
\begin{center}
\vspace{-2mm}
    \includegraphics[scale = .19]{images/autoencodeerNew.png}
    \vspace{-2mm}
\end{center}
...
% ----------------------------------------------------------------
\textcolor{white}{.}\vspace{-5mm}\\ % Add space above column
\section{\href{https://migue-rc.github.io/Data-Science-Cheatsheet/\#time-series}{Time Series}}
...
%%%%%%%%%%%%%%%%%%%%%%
\section{\href{https://migue-rc.github.io/Data-Science-Cheatsheet/\#naive-bayes}{Naive Bayes}}
...
\section{\href{https://migue-rc.github.io/Data-Science-Cheatsheet/\#ab-testing}{A/B Testing}}
...
\textbf{Multivariate Testing} - compares $3+$ variants or combinations, but requires larger sample sizes
