...
General metric used to calculate distance between two vectors in a normed vector space:
...
primarily used to compare categorical strings or binary vectors of equals length. 
